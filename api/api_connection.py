...
try:
    ...
    logging.info("dotenv library not found. Please install it with 'pip install python-dotenv'")
...
def get_access_token():
    ...
    # --- Initial Authentication Flow ---
        ...
        logging.info("3. Please copy that entire URL from your browser's address bar and paste it here.")
...
def get_athlete_activities(access_token):
    """Fetches the last 5 activities for the authenticated athlete."""
    if not access_token:
